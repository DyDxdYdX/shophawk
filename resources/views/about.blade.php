                        ...
                        <div class="bg-gray-50 p-6 rounded-lg">
                            ...
                            <div class="space-y-4">
                                @forelse ($feedbacks as $feedback)
                                    <div class="bg-white p-4 rounded-lg shadow-sm" data-feedback-id="{{ $feedback->id }}" data-category="{{ $feedback->category }}">
                                        <div class="flex justify-between items-start">
                                            ...
                                            @if (!auth()->user()->is_admin)
                                                <div class="flex space-x-2">
                                                    <button type="button" 
                                                            onclick="editFeedback({{ $feedback->id }}, '{{ str_replace("'", "\\'", $feedback->feedback) }}')"
