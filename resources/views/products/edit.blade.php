                ...
                <div class="p-6 text-gray-900">
                    ...
                    <form action="{{ route('products.update', $product) }}" method="POST" class="space-y-6">
                        ...
                        <div>
                            ...
                            <input type="url" name="product_link" id="product_link" value="{{ old('product_link', $product->product_link) }}"
                                class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500">
                        </div>

                        <div>
                            <label for="img_link" class="block text-sm font-medium text-gray-700">Image Link</label>
                            <input type="url" name="img_link" id="img_link" value="{{ old('img_link', $product->img_link) }}"
                                class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500">
                        </div>
